...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const esquioUrl = "https://3a08123b.ngrok.io"; //core.getInput('esquio-url');
            const esquioApiKey = "AG6+sjVYxBdxPaqoOdazWKT3c3lnyz7zhWIvNB9TcLw="; //core.getInput('esquio-api-key');
            const productName = "Default"; //core.getInput('product-name');
            const featureName = "MatchScore"; //core.getInput('feature-name');
